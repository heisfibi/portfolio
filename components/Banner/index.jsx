...
(
    <>
        ...
        <div className='w-full h-[350px] lg:h-[calc(100vh-100px)] object-fill bg-fixed bg-[url("https://i.ibb.co/wQT8tCg/122427480-161210105663948-3594706252189084805-n.jpg")]'>
